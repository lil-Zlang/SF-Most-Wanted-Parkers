...
export default function AllCitationsMap() {
  ...
  // Load default citations (top 20 most expensive) on mount
  useEffect(() => {
    loadCitations();
  }, []);
    ...
    return (
      <div className="w-full h-[600px] bg-gray-100 rounded-lg flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading citations from database...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="w-full">
      ...
      <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-lg border border-blue-100">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Filter Citations</h2>
        </div>
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  !month.available
                    ...
                    : 'bg-white border-2 border-gray-200 text-gray-700 hover:border-blue-300 hover:shadow-sm'
                }`}
        ...
        <div className="flex items-center justify-between pt-4 border-t border-blue-200">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 transition-all duration-200 flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
          ...
          <div className="text-right">
            <div className="text-lg font-bold text-gray-800">{citations.length}</div>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-2xl font-bold text-gray-800">Citations Map</h2>
          {isGeocoding && (
            <div className="flex items-center gap-2">
              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-blue-600"></div>
              <span className="text-sm text-gray-600">Geocoding addresses...</span>
            </div>
          )}
        </div>
      ...
      <div className="mt-4 p-4 bg-white rounded-lg shadow">
        <h3 className="font-semibold text-gray-800 mb-3">Citation Fine Amount Legend</h3>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">$300-499</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-amber-500"></div>
            <span className="text-sm text-gray-600">$200-299</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-yellow-500"></div>
            <span className="text-sm text-gray-600">$100-199</span>
          </div>
          <div className="flex items-center gap-2">
